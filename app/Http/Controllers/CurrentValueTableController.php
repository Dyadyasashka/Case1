...
class CurrentValueTableController extends Controller
{
   public function index(Request $request, $meter_id, $dataType = 'voltage')
   {
    ...
    //dd($dataPoints);
       return view('currentvaluetable', ['currentvalue' => $currentValues, 'dataPoints' => $dataPoints, 'meter_id' => $meter_id, 'dataType' => $dataType]);
   }
}